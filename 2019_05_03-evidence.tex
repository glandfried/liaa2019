...
\begin{center}
  \textbf{Bayesian inference is about hidden variables}
...
\begin{frame}
 \begin{textblock}{128}(0,8)
\begin{center}
 \large Bayesian skill estimator
\end{center}
\end{textblock}
\vspace{1.25cm}
