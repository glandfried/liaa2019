...
\Wider[3em]{
 ...
 About our \textbf{belief distributions} for those hidden variables!
 \end{mdframed} 
}
 \pause 
 ...
 \centering{To update our beliefs (posterior), we need to consider every possible path in our \textbf{model} that could led as to the observed \textbf{data} (likelihood).}
