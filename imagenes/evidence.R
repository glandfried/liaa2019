...
mtext(text ="P(D|M) = Evidence" ,side =2,line=1,cex=1.33,at = 0.2)

segments(-1.8,-0.05,-1.6,0.4,lty=3)
segments(1.8,-0.05,1.6,0.4,lty=3)
text(0,-0.025, "Constrained\n model wins",srt=0, cex=1)
text(6,-0.025, "Flexible\n model wins",srt=0, cex=1)
text(-6,-0.025, "Flexible\n model wins",srt=0, cex=1)

legend(2,0.3,lty = c(1,2),lwd=c(2,2),
       legend = c("Constrained model","Flexible model"),bty = "n",cex = 1.2)
